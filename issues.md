...
- [ ] Koppelingen are imported correctly with readable names (not just UUIDs — see #312)
...
- [ ] Auto-generated OAS documentation is accessible via Redocly URL
...
**Key Context from Comments:** The GEMMA data is served by a separate register (#148). This issue covers the Softwarecatalogus (voorzieningen) data specifically.
...
**Acceptance Criteria:**
- [ ] The ArchiMate API auto-generated documentation (OAS) is accessible
...
- [ ] No connections appear as UUIDs or "Geen titel" in search results
